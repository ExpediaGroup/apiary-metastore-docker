...
## [1.16.0] - TBD
### Added
Add the option of deleting certain Hive databases when the metastore starts up. Will also enable cascading-deletes on the MySQL tables before deleting, then will remove cascading-deletes. See variables `ENABLE_SCHEMA_DELETION` and `HIVE_DBS_TO_DELETE` in [README.md](README.md).

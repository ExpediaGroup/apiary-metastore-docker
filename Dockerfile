...
ENV APIARY_METASTORE_LISTENER_VERSION 1.0.0
ENV APIARY_GLUESYNC_LISTENER_VERSION 1.0.0
ENV APIARY_RANGER_PLUGIN_VERSION 1.0.0
ENV APIARY_METASTORE_METRICS_VERSION 1.0.0

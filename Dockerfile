...
ENV APIARY_EXTENSIONS_VERSION 8.1.13
ENV APIARY_GLUESYNC_LISTENER_VERSION 8.1.13
ENV APIARY_RANGER_PLUGIN_VERSION 8.1.13
ENV APIARY_METASTORE_METRICS_VERSION 8.1.13
ENV APIARY_METASTORE_AUTH_VERSION 8.1.13
...
RUN wget -q -O - https://downloads.apache.org/maven/maven-3/${MAVEN_VERSION}/binaries/apache-maven-${MAVEN_VERSION}-bin.tar.gz | tar -C /opt -xzf - && \

...
wget -q https://oss.sonatype.org/content/repositories/snapshots/com/expediagroup/apiary/apiary-metastore-listener/${APIARY_EXTENSIONS_VERSION}/apiary-metastore-listener-8.1.3-20250410.152353-1-all.jar -O apiary-metastore-listener-${APIARY_EXTENSIONS_VERSION}-all.jar && \
wget -q https://oss.sonatype.org/content/repositories/snapshots/com/expediagroup/apiary/kafka-metastore-listener/${APIARY_EXTENSIONS_VERSION}/kafka-metastore-listener-8.1.3-20250410.152353-1-all.jar -O kafka-metastore-listener-${APIARY_EXTENSIONS_VERSION}-all.jar && \
wget -q https://oss.sonatype.org/content/repositories/snapshots/com/expediagroup/apiary/apiary-gluesync-listener/${APIARY_GLUESYNC_LISTENER_VERSION}/apiary-gluesync-listener-8.1.3-20250410.152353-1-all.jar -O apiary-gluesync-listener-${APIARY_GLUESYNC_LISTENER_VERSION}-all.jar && \
wget -q https://oss.sonatype.org/content/repositories/snapshots/com/expediagroup/apiary/apiary-ranger-metastore-plugin/${APIARY_RANGER_PLUGIN_VERSION}/apiary-ranger-metastore-plugin-8.1.3-20250410.152353-1-all.jar -O apiary-ranger-metastore-plugin-${APIARY_RANGER_PLUGIN_VERSION}-all.jar && \
wget -q https://oss.sonatype.org/content/repositories/snapshots/com/expediagroup/apiary/apiary-metastore-auth/${APIARY_METASTORE_AUTH_VERSION}/apiary-metastore-auth-8.1.3-20250410.152353-1.jar -O apiary-metastore-auth-${APIARY_METASTORE_AUTH_VERSION}.jar && \

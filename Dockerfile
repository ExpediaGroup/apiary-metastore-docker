...
ENV APIARY_EXTENSIONS_VERSION 8.1.12
ENV APIARY_GLUESYNC_LISTENER_VERSION 8.1.12
ENV APIARY_RANGER_PLUGIN_VERSION 8.1.12
ENV APIARY_METASTORE_METRICS_VERSION 8.1.12
ENV APIARY_METASTORE_AUTH_VERSION 8.1.12
